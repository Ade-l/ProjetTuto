/*
Cette fonction javascript sert à envoyer une requete sans avoir à recharger la page!
Elle affichera dynamiquement la réponse.
 */
function checkForm() {
    // on récupère l'élément mail
        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            if (!resp["error"]) {
                if (resp["status"] === "success") {
                    ...
                    text.disabled = true;
                    text.placeholder =
                        "Veuillez patientez deux minutes pour pouvoir ré-écrire!";
                    result.hidden = false;
